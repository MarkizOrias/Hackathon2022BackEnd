...
contract ProofOfProp is Ownable {
    ...
    // ToDo: _priceFeedAddress to be removed
    constructor(
    ...
    modifier OnlyContractOwner() {
        require(msg.sender == contract_owner, "Your account address is not an owner of the contract");
        //run this then...
        _;
        //...all the rest
    }
    ...
    function record() public payable {
        require(msg.value >= getMinimumFee(), "Not enough ETH! Entry below minimum fee in USD"); // Check if payment is equal or above minimum fee
    ...
    // Why do we call require if we use OnlyContractOwner function ?? It is just double check
